...
public class ResistanceDuSol {
    ...
    //
    public static double capacitePortance(double qELS, double eccentricite, double largeur, Combinaison combinaison) {
    ...
    //
    public static double resistantGlissement(double excentricite, double largeur, double Vd, Combinaison combinaison) {
